<script lang="ts">
  ...
  async function rollDice() {
    if (!player || !isTurn) {
      console.warn("It's not your turn or player data is missing");
      return;
    }
    ...
    console.log(`Dice rolled: ${dice1} and ${dice2}. Total: ${totalRoll}`);

    const newPosition = (player.position + totalRoll) % 40;
  ...
  async function advanceTurn() {
    ...
    players.forEach((player, i) => {
      if (player.id === currentTurnPlayerId) {
        nextPlayerId = players[(i + 1) % players.length].id;
        return;
      }
    });
...
<!-- MAIN AREA -->
<div
  class="flex flex-col absolute right-0 h-full w-[calc(100vw-100vh)] bg-base-100"
>
  ...
  <div class="flex flex-3 bg-base-300 items-center justify-around">
    ...
    >
      <!-- prettier-ignore -->
      <svg class="size-[5em] fill-base-100" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M192,32H64A32.03667,32.03667,0,0,0,32,64V192a32.03667,32.03667,0,0,0,32,32H192a32.03667,32.03667,0,0,0,32-32V64A32.03667,32.03667,0,0,0,192,32ZM92,176a12,12,0,1,1,12-12A12,12,0,0,1,92,176Zm0-72a12,12,0,1,1,12-12A12,12,0,0,1,92,104Zm36,36a12,12,0,1,1,12-12A12,12,0,0,1,128,140Zm36,36a12,12,0,1,1,12-12A12,12,0,0,1,164,176Zm0-72a12,12,0,1,1,12-12A12,12,0,0,1,164,104Z"></path> </g></svg>
    </button>
  </div>
</div>
